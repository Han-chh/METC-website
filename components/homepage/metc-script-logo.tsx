...
const METC_C_GUIDE_PATH =
  "M 660 31 C 623 18 548 20 494 42 C 455 58 450 79 492 92 C 545 108 625 94 660 73";
  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        <mask id="metc-logo-c-cutout" maskUnits="userSpaceOnUse">
          <rect x="0" y="0" width="708" height="116" fill="#fff" />
          <rect x="444" y="15" width="252" height="94" fill="#000" />
        </mask>
      ...
      <g clipPath="url(#metc-logo-write-clip)">
        ...
        />
        <path
          className="metc-script-logo__one-stroke"
          d={METC_C_GUIDE_PATH}
          fill="none"
          stroke="#FFFDF2"
          strokeWidth="14"
