...
const METC_LOGO_PATH = METC_LOGO_BASE_PATH
  .replace(
    "Q 94.25 18 91 18 Q 87.75 18.25 87.75 19.5 Q 87.75 20.75 85 21 Q 81.75 20.8 81.25 20.05 Q 80.75 19.3 78.75 18.5",
    "Q 94.25 18 91 18 C 88.5 18.15 86.25 19.2 84.75 20.25 C 82.8 20.2 81.3 19.65 80.25 19 Q 79.5 18.65 78.75 18.5",
  )
  .replace(
    "Q 218.25 19 209.88 19 Q 201.5 19 200.38 20 Q 199.25 21 195.38 21 Q 191.5 21 187 23.5",
    "Q 218.25 19 209.88 19 C 205.8 19 202.4 19.3 199.9 20.35 C 198.5 20.95 196.8 21.1 195.38 21 C 192.4 21.15 189.5 22.4 187 23.5",
  )
  .replace(
    "Q 599.75 60.5 603 58.62 Q 606.25 56.75 608.38 54 Q 610.35 51.1 607.85 49.75 Q 605.35 48.4 597.75 53.62 Q 590.25 59 585.75 61.5 Q 581.25 64 578.75 64.38 Q 576.25 64.75 575.5 63.12 Q 574.9 61.45 575.8 60.35 Q 576.7 59.25 577.25 54.88",
    "Q 599.75 60.5 603 58.62 C 605.15 57.35 607.05 55.75 608.38 54 C 609.8 52.1 609.1 50.55 607.35 50.05 C 604.75 49.35 599.9 52.65 596.75 54.75 Q 590.25 59 585.75 61.5 C 581.25 64 579.3 64.45 578.3 64.35 C 576.7 64.2 575.75 63.45 575.4 62.35 C 575.05 61.2 575.4 60.2 576.2 59.3 C 577 58.4 577.15 56.4 577.25 54.88",
  );
...
export function MetcScriptLogo() {
  return (
    ...
    >
      ...
      <g className="metc-script-logo__write-head" aria-hidden="true">
        <animateMotion
          dur="4.9s"
          begin=".08s"
          fill="freeze"
          path={METC_DRAW_GUIDE_PATH}
          calcMode="spline"
          keyTimes="0;1"
          keySplines=".45 0 .2 1"
        />
        <circle className="metc-script-logo__write-head-halo" cx="0" cy="0" r="13" />
        <circle className="metc-script-logo__write-head-core" cx="0" cy="0" r="4.2" />
        <circle className="metc-script-logo__write-head-dust metc-script-logo__write-head-dust-a" cx="-10" cy="-3" r="2.2" />
        <circle className="metc-script-logo__write-head-dust metc-script-logo__write-head-dust-b" cx="-15" cy="5" r="1.6" />
        <circle className="metc-script-logo__write-head-dust metc-script-logo__write-head-dust-c" cx="-6" cy="8" r="1.3" />
      </g>
