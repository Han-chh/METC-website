...
export function MetcScriptLogo() {
  return (
    ...
    >
      ...
      <defs>
        <linearGradient id="metc-logo-background" x1="20" y1="4" x2="692" y2="112" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#E5D8B8" />
          <stop offset="0.48" stopColor="#D9AA7D" />
          <stop offset="1" stopColor="#C87559" />
        </linearGradient>
        <radialGradient
          id="metc-logo-left-glow"
          cx="0"
          cy="0"
          r="1"
          gradientTransform="translate(74 111) rotate(-24) scale(300 94)"
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#F5DCA6" stopOpacity="0.58" />
          <stop offset="1" stopColor="#F5DCA6" stopOpacity="0" />
        </radialGradient>
        <radialGradient
          id="metc-logo-right-glow"
          cx="0"
          cy="0"
          r="1"
          gradientTransform="translate(632 62) rotate(180) scale(91 47)"
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#FFE7A6" stopOpacity="0.36" />
      ...
      <rect width="708" height="116" fill="url(#metc-logo-background)" />
      <rect width="708" height="116" fill="url(#metc-logo-left-glow)" />
      <rect width="708" height="116" fill="url(#metc-logo-right-glow)" />
      ...
      <g clipPath="url(#metc-logo-write-clip)">
        <path
          ...
          aria-hidden="true"
        />
        <path className="metc-script-logo__one-stroke" d={METC_LOGO_PATH} fill="#FFFDF2" fillRule="evenodd" />
      </g>
